...
#include <iostream>
using namespace sdt;  //mistaken spelling of std // pp. 38-39 in Savitch 6/e explains this line

int main()
{
	int numSurveyed //no semicolon, so the next variable is not delcared
	int numApprove;
	int numDisapprove;
